...
|---|---|---|---|
| Clean Recalbox installation | Recalbox has completed first boot and created SHARE as exFAT | Erases all SHARE data and recreates it as ext4 | `--confirm-install`  
`--confirm-format` |
