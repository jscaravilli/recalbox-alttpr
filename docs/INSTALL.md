...
|---|---|---|---|
| Clean Recalbox installation | Standard `/dev/mmcblk0p2` partition labeled `SHARE`; current filesystem does not matter | Erases all SHARE data and creates ext4 | `--confirm-install --confirm-format` |
